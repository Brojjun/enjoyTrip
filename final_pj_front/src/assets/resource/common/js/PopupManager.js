...
const PopupManager = {
  ...
  checkContentsFullSize: function (el) {
    let _this = this;
    let contentsCon = el.querySelector('.popup_con');
    let contents = contentsCon.querySelector('.popup_inner');
  ...
  */
  ...
  repositioning: function (el) {
    ...
    window.addEventListener('resize', function () {
      _this.isMobile = Common.checkMobileSize();
  ...
  add: function (el, closeCallbackFn) {
    ...
    _this.isMobile = Common.checkMobileSize() ? true : false;
  ...
  lockScroll: function () {
    ...
    let initWidth = $body.clientWidth;
    let initHeight = $body.clientHeight;
    ...
    let marginR = $body.clientWidth - initWidth;
    let marginB = $body.clientHeight - initHeight;
